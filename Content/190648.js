app = angular.module("APP").controller("Ctrl190648", ['$rootScope', '$scope', '$http', '$q', '$filter', '$translate', '$mdToast', '$http', function ($rootScope, $scope, $http, $q, $filter, $translate, $mdToast, $http) {
    ...
    $scope.makeDesign_272372 = function (param) {
        $rootScope.design_10157($scope, param);
    };

    $scope.makeDesign_272370 = function(param){
        $rootScope.design_10116($scope,param);
    };
