app = angular.module("APP").controller("Ctrl190495", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272437 = function(param){ 
	 $rootScope.design_10160($scope,param); 
} 

$scope.makeDesign_293029 = function(param){ 
