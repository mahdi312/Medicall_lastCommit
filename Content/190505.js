app = angular.module("APP").controller("Ctrl190505", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_272527 = function(param){ 
	 $rootScope.design_20249($scope,param); 
} 
