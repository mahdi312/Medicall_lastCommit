app = angular.module("APP").controller("Ctrl190611", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_282775 = function(param){ 
	 $rootScope.design_10100($scope,param); 
} 

$scope.makeDesign_282776 = function(param){ 
	 $rootScope.design_20231($scope,param); 
} 
