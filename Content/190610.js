app = angular.module("APP").controller("Ctrl190610", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_282709 = function(param){ 
	 $rootScope.design_20230($scope,param); 
} 
