app = angular.module("APP").controller("Ctrl190574", ['$rootScope','$scope', '$http','$q','$filter','$translate','$mdToast','$http', function ($rootScope,$scope, $http,$q, $filter,$translate,$mdToast,$http){
...
$scope.makeDesign_282800 = function(param){ 
	 $rootScope.design_20229($scope,param); 
} 

$scope.makeDesign_293309 = function(param){ 
